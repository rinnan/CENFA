...
`Maintainer: D. Scott Rinnan <rinnan@u.washington.edu>`
...
par(mar = c(1, 1, 1, 1))
plot(QUGA, col = "darkgreen", main = "Oregon white oak sensitivity to climate change")
...
par(mar = c(1, 1, 1, 1))
plot(QUGA, col = "darkgreen", main = "Oregon white oak exposure to climate change")
maps::map("state", regions = c("California", "Oregon", "Washington"), add = T, resolution = 0)
maps::map("world", regions = c("Canada"), add = T, resolution = 0)
map(e.map, type = "sd", n = 2, add = T,
    smallplot = c(.7, .71, .3, .7))
```
...
par(mar = c(1, 1, 1, 1))
plot(QUGA, col = "darkgreen", main = "Oregon white oak vulnerability to climate change")
maps::map("state", regions = c("California", "Oregon", "Washington"), add = T, resolution = 0)
maps::map("world", regions = c("Canada"), add = T, resolution = 0)
map(v.map, type = "sd", n = 2, add = T,
    smallplot = c(.7, .71, .3, .7))
```
